...
internal class StoreFileGenerator(
    ...
    private val className: String = "${visitor.className.simpleName}Impl"
    ...
    init {
        fileSpec.apply {
            addFileComment("Class implementation generated by EasyStore (https://github.com/kasem-sm/EasyStore)")
            ...
            addType(
                TypeSpec.classBuilder(className).apply {
                    addSuperinterface(visitor.className)
                    // Class constructor
